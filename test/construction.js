...
test('factory construction - with default enumeration data and methods', t => {
  ...
  var MyClass = StateMachine.factory({
    ...
    methods: {
      talk: function() {
        return this.state + ' - ' + this.ENUM[this.state]
      }
    }
  });
...
test('factory construction - with enumeration data and methods', t => {
  ...
  var MyClass = StateMachine.factory({
    ...
    methods: {
      talk: function() {
        return this.state + ' - ' + this.ENUM[this.state] + ' - '+ this.value;
      }
    }
  });
